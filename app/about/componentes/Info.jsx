export default function Info () {
    return (
        <>
            <nav className="Info">
                <img className="Photo" src="./media/img/Photo.jpeg" alt="Photo" />
            
                <h2>Wilson Bravo</h2>
                <h3>App Developer</h3>
                <h5><a href="https://github.com/WilsonBravo" target="_blank">github.com/WilsonBravo</a></h5>

                <div className="info--buttons">
                    <a className="Email" href="mailto:bravoc.wilson@gmail.com"><svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
Email</a>
                    <a className="LinkedIn" href="https://www.linkedin.com/in/wilson-bravo/" target="_blank"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
